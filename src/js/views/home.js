...
export const Home = () => {
	...
	const confirmDelete = () => {
		actions.deletecontact(selectid);
		setSelectid(null);
					...
					return (
						...
						>
							...
							<div className="d-flex align-items-center">
								...
								<button type="button" className="btn btn-danger" data-bs-toggle="modal" onClick={() => holdId(item.id)} data-bs-target="#confDeletemodal"><i className="fa-solid fa-trash-can"></i></button>
							</div>
				...
				<div className="modal-dialog">
					<div className="modal-content">
						...
						<div className="modal-footer">
							...
							<button onClick={confirmDelete} type="button" className="btn btn-primary">Yes baby!</button>
						</div>
					</div>
				</div>
			</div>
